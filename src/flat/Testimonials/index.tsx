    ...
    >
      <Container width={{ base: "full", sm: "lg", lg: "xl" }} margin={"auto"}>
        <chakra.h3
          ...
          color={data.color_scheme.secondary}
        >
          People love us
        </chakra.h3>
        <chakra.h1
        ...
        {data.copy.testimonials.testimonial_items.map(
          (testimonial: any, index: number) => (
            <TestimonialCard
              key={index}
              data={testimonial}
              quoteColor={data.color_scheme.secondary}
              index={index}
            />
          )
        )}
